...
export const PAINTINGS: Painting[] = [
  // ---------------- Picasso (8 active) ----------------
  {
    ...
    inspirationVideo: '/videos/montmartre.mp4',
  ...
  },
  {
    ...
    inspirationVideo: '/videos/antibes.mp4',
  ...
  },
  {
    ...
    medium: 'Oil on canvas',
    viewingLocation: 'To follow',
    inspirationVideo: '/videos/cote-azur.mp4',
  ...
  },
  {
    ...
    inspirationVideo: '/videos/russian-folk.mp4',
  ...
  },
  {
    ...
    signed: 'Signed upper right',
    viewingLocation: 'Switzerland',
    inspirationVideo: '/videos/african-masks.mp4',
  ...
  // ---------------- Da Vinci (1) ----------------
  {
    ...
    viewingLocation: 'Switzerland',
    inspirationVideo: '/videos/milan-court.mp4',
  ...
  // ---------------- Raphael (1 active) ----------------
  {
    ...
    medium: 'Oil on canvas',
    viewingLocation: 'To follow',
    inspirationVideo: '/videos/florence-workshop.mp4',
  ...
  // ---------------- Monet (1) ----------------
  {
    ...
    inspirationVideo: '/videos/nvai_monet_secret_garden_5k.mp4',
    inspirationNote:
  ...
  // ---------------- Kandinsky (2) ----------------
  {
    ...
    signed: 'Signed',
    viewingLocation: 'To follow',
    inspirationVideo: '/videos/moscow.mp4',
  ...
  },
  {
    ...
    inspirationVideo: '/videos/music-synesthesia.mp4',
  ...
  // ---------------- Kahlo (1) ----------------
  {
    ...
    signed: 'Signed',
    viewingLocation: 'UAE',
    inspirationVideo: '/videos/pain-suffering.mp4',
  ...
  // ---------------- Pollock (2 — newly added) ----------------
  {
    ...
    viewingLocation: 'To follow',
    inspirationVideo: '/videos/studio-revolution.mp4',
  ...
  },
  {
    ...
    viewingLocation: 'To follow',
    inspirationVideo: '/videos/abstract-harmony.mp4',
  ...
  // ---------------- Bernard (1) ----------------
  {
    ...
    inspirationVideo: '/videos/nvai_raphael_chapel_5k.mp4',
