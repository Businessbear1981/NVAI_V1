        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              {
                title: 'IV · The cabaret · La Vie en Rose · the rose',
                prompt:
                  "60-second cabaret sequence. 1920s Montparnasse intimate cabaret bar — low candlelit ceiling, smoke, small round café tables packed close, a stage of weathered wood barely raised off the floor. Amedeo Modigliani walks in from the back alone — tall, broad shoulders, brown velvet jacket worn at the elbows, the look of a man at the end of a long day. He takes a tiny table at the front and orders a Pernod. On stage: Kiki de Montparnasse mid-song — slip dress, dark bob, kohl-lined eyes, scarlet lips, holding the microphone the way Lady Gaga's Ally does. She is singing 'La Vie en Rose' (Edith Piaf). Halfway through the song she steps off the stage and walks slowly through the tables, still singing. She reaches Modigliani's table, brushes the back of her hand along his cheek, and lays a single red rose on the marble in front of him. His eyes well up. He doesn't move. She holds his gaze one beat — recognition — and walks back to the stage to finish the song. Reference: A Star Is Born (2018), the early drag-bar scene where Jackson Maine first walks in and Ally performs 'La Vie en Rose.' Same intimacy, same gravity, same tears. Style: warm 1970s film stock, candle and gas-sconce light, painterly, the room fading around the two of them. Aspect 16:9. 60 second loop, tasteful, no explicit content.",
              },
              {
