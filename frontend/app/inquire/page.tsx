  ...
  if (status === 'success') {
    return (
      <div className="mx-auto max-w-xl text-center space-y-6">
        ...
        <h2 className="font-didot text-3xl uppercase tracking-[0.12em] text-ivory">Thank you</h2>
        <p className="font-display italic text-gold/85">Bernard has your message.</p>
...
export default function InquirePage() {
  return (
    ...
    >
      <Suspense fallback={<div className="mx-auto max-w-2xl text-center font-mono text-[0.55rem] uppercase tracking-[0.32em] text-gold/50">Loading the inquiry form…</div>}>
        <InquireForm />
      </Suspense>
    </WingLayout>
  );
